...
STANDING_CALIBRATION_PROFILE_NAME = "g1_standing_calibration_raw_v2"
...
# Reuse the complete tabletop recording contract, with standing arm-SDK commands.
# Selected calibration images cannot preserve failed views or motion between poses.
STANDING_CALIBRATION_TOPICS = tuple(
    topic for topic in TABLETOP_RAW_TOPICS if topic.name != "/lowcmd"
) + (
    TopicSpec(
        "/arm_sdk",
        "unitree_hg/msg/LowCmd",
